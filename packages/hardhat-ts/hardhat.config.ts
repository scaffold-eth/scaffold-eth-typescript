 ...
 * - network definitions are in getNetworks in the scaffold-common workspace: `scaffold-common/src/functions`
 * - Named hardhat accounts are in the scaffold-common workspace: `scaffold-common/src/constants`
