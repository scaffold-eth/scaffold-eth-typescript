...
import { hardhatNamedAccounts } from '@scaffold-eth/scaffold-common/src/constants';
import { getNetworks } from '@scaffold-eth/scaffold-common/src/functions';
 ...
 * - network definitions are in getNetworks in the '@scaffold-eth/scaffold-common/src workspace: `'@scaffold-eth/scaffold-common/src/functions`
 * - Named hardhat accounts are in the '@scaffold-eth/scaffold-common/src workspace: `'@scaffold-eth/scaffold-common/src/constants`
...
/**
 * loads network list and config from '@scaffold-eth/scaffold-common/src
 */
const networks = {
  ...getNetworks({
    accounts: {
