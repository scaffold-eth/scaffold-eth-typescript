...
import { MainPageFooter, MainPageHeader, createTabs, TContractPageList } from '.';
...
export const MainPage: FC = () => {
  const notificationHolder = <div></div>; //useCreateAntNotificationHolder();
  // -----------------------------
  ...
  const { tabMenu } = createTabs(pageList, route, setRoute);
  ...
  return (
    <Layout
      ...
      notificationHolder={notificationHolder}></Layout>
  );
};
